...
import { all, modifierApi, supprimerApi, URL } from "./apis/produitApi";
...
function App() {
 ...
 const navigate= useNavigate();
  ...
  const modifier = (e) => {
    e.preventDefault();
    modifierApi(produit).then(r=>{
      console.log('resultat',r)
      setProduits(produits.map((p) => (p.id === produit.id ? r : p)));
      setProduit(init);
  ...
  return (
    <>
        ...
        <Link to="/new">Nouveau</Link> -<Link to="/liste">Liste</Link>
